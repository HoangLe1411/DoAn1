...
namespace DoAn1.Controllers
{
    public class ProductImagesController : Controller
    {
        ...
        public ProductImagesController(CsdlDoAn1Context context)
        {
            _context = context;
        }
        ...
        {
            var csdlDoAn1Context = _context.ProductImages.Include(p => p.Product);
        ...
        public async Task<IActionResult> Create([Bind("ImageId,ProductId,ImageUrl")] ProductImage productImage)
        {
