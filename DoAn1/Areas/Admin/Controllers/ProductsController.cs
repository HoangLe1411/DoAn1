...
namespace DoAn1.Areas.Admin.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProductId,UserId,Title,Description,Price,Status,Condition,Location,CategoryId,SubCategoryId,IsSold,Brand,WarrantyPeriod,UsedDuration,Type,TotalRating,RatingCount,CreatedAt,UpdatedAt,IsActive")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductId,UserId,Title,Description,Price,Status,Condition,Location,CategoryId,SubCategoryId,IsSold,Brand,WarrantyPeriod,UsedDuration,Type,TotalRating,RatingCount,CreatedAt,UpdatedAt,IsActive")] Product product)
        {
